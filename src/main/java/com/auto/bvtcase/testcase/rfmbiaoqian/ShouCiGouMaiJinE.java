...
public class ShouCiGouMaiJinE {
    ...
    @Test(description = "首次购买金额")
    public void testGetApi() throws SQLException {
        Integer api = JsonParseUtil.parseType(JsonParseUtil.parseJson(RequestApi.getApi("src/main/java/com/auto/data/rfmbiaoqian/首次购买金额.json",token)).get("data").toString());
